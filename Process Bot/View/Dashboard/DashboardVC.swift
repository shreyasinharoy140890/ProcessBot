...
override func viewDidLoad() {
    ...
    buttonradioonemonth.isSelected = true
    if  buttonradioonemonth.isSelected == true
    {
        days = "30"
        period = 1
...
@objc @IBAction private func logSelectedButton(radioButton : DLRadioButton) {
    if (radioButton.isMultipleSelectionEnabled) {
        ...
        if (radioButton.selected()!.titleLabel!.text!) == "   1 month" ||  buttonradioonemonth.isSelected == true
        {
            print ("30 days")
            days = "30"
            period = 1
        ...
        else if (radioButton.selected()!.titleLabel!.text!) == "   3 months"
        {
            print ("90 days")
            days = "90"
            period = 3
        ...
        else if (radioButton.selected()!.titleLabel!.text!) == "   1 year"
        {
            print ("365 days")
            days = "365"
            period = 12
        ...
        else if (radioButton.selected()!.titleLabel!.text!) == "   5 years"
        {
            print ("1825 days")
            days = "1825"
            period = 60
