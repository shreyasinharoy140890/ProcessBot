...
extension SuccessRateViewModel {
    func getSuccessRateDetails(completion: @escaping (ProcessBot<Any?>) -> Void) {
        ...
        self.manager?.request(.customGetURL(with: .successratedetails, components: ["ClientID":clientId,"Days":days!]), method: .get,parameters: nil, encoding: .json, headers: headers, handler:   { (result) in
