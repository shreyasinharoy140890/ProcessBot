...
class CostSavingsViewModel:CostSavingsViewModelProtocol {
    ...
    func getSavingsList(completion: @escaping (ProcessBot<Any?>) -> Void) {
        ...
        self.manager?.request(.customGetURL(with: .costsavingsdetails, components: ["ClientID":clientId,"period":"0"]), method: .get,parameters: nil, encoding: .json, headers: headers, handler:   { (result) in
